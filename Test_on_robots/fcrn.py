...
class UpProject(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, batch_size):
        ...
        self.conv1_1 = nn.Conv2d(in_channels, out_channels, 3) # the third argument is the size of the filter,
...
class FCRN(nn.Module):
    ...
    def __init__(self, batch_size):
        ...
        self.conv1 = nn.Conv2d(3, 64, kernel_size=7, stride=2, padding=3, bias=False) # input channels are 3, out channels 64
        ...
        self.upsample = nn.Upsample((128, 160), mode='bilinear') # still need to have a look at this, because
                    # don't really know the meaning of the arguments in the small parenthesis
